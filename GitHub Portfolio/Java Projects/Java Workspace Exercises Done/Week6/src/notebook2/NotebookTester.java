...
public class NotebookTester
{
	...
	System.out.println("");
	System.out.println("");
	System.out.println("*** [Exercise 1-2 Week 6 - Notebook 6] ***");
	Notebook myNotebook6 = new Notebook();
	myNotebook6.storeMessage("Get the car serviced.");
	myNotebook6.storeMessage("Shopping in Liverpool.");
	myNotebook6.storeMessage("Meet at Liverpool station.");
	myNotebook6.storeMessage("Must meet with Abdul.");
	myNotebook6.storeMessage("Get the carpet cleaned.");
	
	System.out.println("[Showing messages]...");
	myNotebook6.listMessagesIterator();
	System.out.println("");
	myNotebook6.removeMessages("car");
